...
@Entity
@Table(name = "ASADDRESSMULTIVALUEFIELD")
public class AsAddressMultiValueField {
    @EmbeddedId
    private AsAddressMultiValueFieldId id;
    ...
    // Getters and Setters
    public AsAddressMultiValueFieldId getId() {
        return id;
    }

    public void setId(AsAddressMultiValueFieldId id) {
        this.id = id;
    }
