...
@Entity
@Table(name = "ASSEGMENTMULTIVALUEFIELD")
public class AsSegmentMultiValueField {
    @EmbeddedId
    private AsSegmentMultiValueFieldId id;
    ...
    public AsSegmentMultiValueFieldId getId() {
        return id;
    }

    public void setId(AsSegmentMultiValueFieldId id) {
        this.id = id;
    }
