...
@Entity(name = "ASACTIVITYFIELD")
public class AsActivityField {

    @EmbeddedId
    private AsActivityFieldId id;
    ...
    // Getters and Setters
    public AsActivityFieldId getId() {
        return id;
    }

    public void setId(AsActivityFieldId id) {
        this.id = id;
    }
