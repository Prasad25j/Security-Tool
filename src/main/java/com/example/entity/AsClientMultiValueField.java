...
@Entity
@Table(name = "ASCLIENTMULTIVALUEFIELD")
public class AsClientMultiValueField {
    
    @EmbeddedId
    private AsClientMultiValueFieldId id;
    ...
    // Getters and setters
    public AsClientMultiValueFieldId getId() {
        return id;
    }

    public void setId(AsClientMultiValueFieldId id) {
        this.id = id;
    }
